...
import com.beautysight.common.bizapp.ex.IllegalParamException;
...
public class PreconditionUtils {
    ...
    public static void checkParam(boolean expression, String errMsgTemplate, String... errMsgArgs) {
        if (!expression) {
            throw new IllegalParamException(String.format(errMsgTemplate, errMsgArgs));
        }
    }
